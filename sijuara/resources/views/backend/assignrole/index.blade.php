...
@section('content')
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Tetapkan Role</h2>
            </div>
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            <div class="flex flex-wrap items-center uppercase text-sm font-semibold bg-pink-400 text-dark-600 rounded-tl">
                <div class="w-3/12 px-4 py-3">Nama</div>
                <div class="w-5/12 px-4 py-3">Email</div>
                <div class="w-2/12 px-4 py-3">Role</div>
                <div class="w-2/12 px-4 py-3 text-right">Tetapkan</div>
            </div>
