    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('classes.create') }}" class="bg-green-500 text-white-50 text-sm uppercase py-2 px-4 flex items-center rounded">
            ...
            @foreach ($classes as $class)
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <a href="{{ route('class.assign.subject',$class->id) }}" class="ml-1 bg-yellow-600 block p-1 border border-yellow-600 rounded-sm" title="assign subject">
