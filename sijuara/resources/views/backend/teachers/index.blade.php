    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('teacher.create') }}" class="bg-blue-500 hover:bg-purple-700 text-white-50 text-sm uppercase py-2 px-4 flex items-center rounded">
                ...
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        <a href="{{ route('teacher.edit',$teacher->id) }}">
                            <button type="submit" class="bg-green-600 block p-1 border border-green-700 rounded-sm">
                        ...
                        <form action="{{ route('teacher.destroy', $teacher->id) }}" method="POST" class="inline-flex ml-1">
                            <button type="submit" class="bg-red-600 block p-1 border border-red-700 rounded-sm">
