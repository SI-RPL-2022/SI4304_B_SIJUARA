    ...
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
            ...
            <div class="flex flex-wrap items-center">
                @foreach ($teacher->classes as $class)
                    <div class="w-full sm:w-1/2 text-center border border-gray-200 rounded">
                        ...
                        <a href="{{ route('teacher.attendance.create',$class->id) }}" class="bg-gray-200 inline-block mb-4 text-xs text-gray-600 uppercase font-semibold px-4 py-2 border border-gray-200 rounded">Kehadiran</a>
                    </div>
                @endforeach
            </div>
        </div>
        <div class="w-full sm:w-1/2 ml-2 mb-6">
            ...
            <div class="flex items-center bg-gray-200 rounded-tl rounded-tr">
                ...
                <div class="w-1/3 text-left text-gray-600 py-2 px-4 font-semibold">Nama MatPel</div>
                <div class="w-1/3 text-right text-gray-600 py-2 px-4 font-semibold">Guru Pengampu</div>
            </div>
